...
Сначала начните с первоначального предположения о расстоянии поворота. Это может быть получено из [steps_per_mm](#Получение rotation_distance от steps_per_mm (или step_distance)) или путем [проверки оборудования](#extruder).
